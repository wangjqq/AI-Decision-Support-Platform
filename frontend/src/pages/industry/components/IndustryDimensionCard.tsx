...
import type { IndustryDimension } from '../../../api/industryApi'
...
export interface IndustryDimensionCardProps {
  data: IndustryDimension | null | undefined
 ...
 * 行业分析单一维度卡片
 * - 头部：图标 + 标题 + 主题色
 * - 主体：summary（可复制）+ keyPoints 列表 + metrics
 */
const IndustryDimensionCard = ({ data, fallbackTitle }: IndustryDimensionCardProps) => {
  if (!data) {
    return null
  }
...
export default IndustryDimensionCard
